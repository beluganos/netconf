...
do_init() {
    ...
    local FRR_USER="frr"
    local SERVICES="beluganos.service nlad.service ribcd.service ribsd.service ribpd.service beluganos.target gobgpd.service cfgd.service netplan-ext.service vrf.service"
